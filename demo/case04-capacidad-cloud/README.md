...
Mientras tanto, Gabriel Ferré (preventa/AE) está trabajando dos oportunidades nuevas y deja constancia tanto al equipo BAU como a leadership de que las va a apoyar con UY-1 ("hay capacidad", "lo vi en el dashboard"). Esa discusión quedó archivada como bitácora en Notion (`ACC-SLACK-01`).
...
Rodrigo pregunta a Krakenmind. La respuesta tiene que cruzar la minuta del comité, la bitácora de pipeline, el ticket de monitoreo y el mail de Mariano para mostrar que tres fuentes apuntan a la misma bolsa de capacidad.

## Fuentes y evidencia

- **Notion** — minuta "Comité Cloudara — capacidad y continuidad" del 2026-04-08 (anchor `ACC-CLOUD-01`); bitácora "Pipeline UY-1: heads-up de preventa y disconnect con comité" en `Cloudara HQ / Leadership / Bitácoras / 2026-04 / Pipeline UY-1` (anchor `ACC-SLACK-01`, captura los heads-up de Gabriel del 13-abr al equipo BAU y a leadership, y la pregunta de Rodrigo).
...
>
> **2. Bitácora de preventa (`ACC-SLACK-01`)** — Notion, "Pipeline UY-1: heads-up de preventa y disconnect con comité" del 2026-04-13. Gabriel Ferré dejó constancia al equipo BAU y a leadership de que está apoyando dos oportunidades nuevas (un retailer y una fintech) con capacidad UY-1, basándose en lo que ve en el dashboard ("hay margen, lo confirmé"). Rodrigo le advierte en el momento que en el comité del 8 hablamos de reservar capacidad. **Estas oportunidades no tienen reserva nominada** y compiten por la misma capacidad ya prometida en (1).
>
